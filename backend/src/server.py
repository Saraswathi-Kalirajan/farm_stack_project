...
MONGODB_URI = "mongodb+srv://saraswathik729:saras1206@cluster0.h5mj6lr.mongodb.net/todo?retryWrites=true&w=majority&appName=Cluster0&tls=true"
...
async def lifespan(app: FastAPI):
    client = AsyncIOMotorClient(
        MONGODB_URI,
        tls=True,
        tlsAllowInvalidCertificates=True  # Note: Only for testing; disable in production
    )
